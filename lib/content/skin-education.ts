...
const rejuranReferences: ReadonlyArray<ArticleReference> = [
  {
    title: "Rejuran US product and science reference",
    url: "https://rejuranpro.com/pages/rejuran-science",
  },
  {
    title: "Philippine FDA Advisory 2022-1001",
    url: "https://www.fda.gov.ph/wp-content/uploads/2022/05/FDA-Advisory-No.2022-1001.pdf",
  },
  {
    title: "Philippine FDA Advisory 2025-0198",
    url: "https://www.fda.gov.ph/wp-content/uploads/2025/03/FDA-Advisory-No.2025-0198.pdf",
  },
];

function rejuranDraft(input: {
  slug: string;
  title: string;
  excerpt: string;
  focus: string;
  ...
  return {
    ...
    tags: ["Rejuran", "polynucleotides", "product verification", input.focus],
    heroImage: "/images/optimized/treatments/skin-support/product-verification-editorial.webp",
    heroAlt: "Clinician reviewing unbranded packaging for a product-verification article",
    ...
    readingMinutes: 6,
    seoTitle: `${input.title} | ESCLARE Education Review`,
    metaDescription: input.excerpt,
    keyTakeaways: [
      "Rejuran is a brand family, so the exact product, formulation, route, and market matter.",
      "Information from another country does not establish Philippine authorization or availability.",
      "ESCLARE has not enabled booking for the reviewed variants pending exact product and regulatory verification.",
    ],
    sections: [
      {
        id: "what-is-being-reviewed",
        title: "What is being reviewed",
        paragraphs: [
          `This draft considers ${input.focus} in the context of manufacturer information, independent polynucleotide literature, and Philippine product-level requirements. It does not confirm that a specific product is stocked or authorized for treatment at ESCLARE.`,
        ],
      },
      {
        id: "why-product-identity-matters",
        title: "Why exact product identity matters",
        paragraphs: [
          "Brand-family names can cover different products in different markets. Packaging, concentration, route, indication, supplier, and regulatory status must all match before treatment information is converted into a clinic service.",
          "A manufacturer claim explains how a company positions a product. It is not the same as independent evidence, a Philippine authorization, or a guarantee of an individual result.",
        ],
      },
      {
        id: "philippine-status",
        title: "Philippine status must be verified first",
        paragraphs: [
          "This review did not verify current Philippine authorization for the exact requested Rejuran Healer, I, or S variants. Philippine FDA advisories have identified specific Rejuran products as unregistered. Those advisories do not decide the status of every variant, but they require exact product-level verification rather than a broad brand claim.",
        ],
      },
      {
        id: "questions-for-consultation",
        title: "Questions a careful consultation should answer",
        paragraphs: [
          "Before any future treatment, a licensed doctor should identify the exact product and permitted route, review source documentation, assess health history and medicines, discuss material risks and alternatives, and set realistic expectations without promising a fixed result.",
        ],
      },
    ],
    beforecare: [
      "Do not buy or bring an unverified product for clinic administration.",
      "Prepare a complete list of medicines, allergies, prior procedures, and relevant health conditions.",
      "Ask to see the exact product identity and current Philippine authorization before consent.",
    ],
    aftercare: [
      "No product-specific aftercare is published until the exact product and route are verified.",
      "Follow only the treating doctor's written instructions if an authorized treatment proceeds.",
      "Seek prompt advice for severe or worsening symptoms.",
    ],
    unsuitable: [
      "Anyone relying only on a reseller listing, social-media post, or foreign-market claim",
      "Anyone who has not completed a doctor assessment",
      "Any situation where product source, authorization, storage, or route cannot be verified",
    ],
    contactClinic: [
      "To ask whether exact product verification has been completed",
      "To report an unexpected reaction after any procedure",
      "To clarify whether a consultation request is pending or confirmed",
    ],
    faqs: withStandardFaqs([
      {
        question: "Can I book a Rejuran treatment from this article?",
        answer:
          "No. These pages are review drafts. ESCLARE has disabled treatment booking until exact Philippine authorization and supply documentation are approved.",
      },
      {
        question: "Does a foreign manufacturer page prove Philippine approval?",
        answer:
          "No. It can support product identity or manufacturer positioning, but Philippine status requires a matching local record for the exact product and intended use.",
      },
      {
        question: "What evidence should be checked before treatment is offered?",
        answer:
          "The clinic should match the exact sealed product, formulation, Philippine record, authorized supplier, permitted route, lot and expiry information, storage requirements, and doctor-approved protocol.",
      },
    ]),
    references: [...regenerativeReferences, ...rejuranReferences],
    relatedArticles: ["pdrn-polynucleotides-guide"],
    relatedTreatments:
...
export const educationArticles: ReadonlyArray<EducationArticle> = [
  ...
  },
  {
    ...
    heroImage: "/images/optimized/treatments/skin-support/skin-hydration-editorial.webp",
    ...
    relatedTreatments: [{ label: "MCCM Exosome PDRN", href: "/treatments/mccm-exosome-pdrn" }],
  },
  {
  ...
  },
  {
    ...
    heroImage: "/images/optimized/treatments/skin-support/brightening-system-editorial.webp",
  ...
  rejuranDraft({
    slug: "rejuran-healer-guide",
    title: "Rejuran Healer: Product Identity, Evidence, and Philippine Review",
    excerpt:
      "A cautious review of the proposed Rejuran Healer service, why exact product identity matters, and what must be verified before booking.",
    focus: "overall skin-quality support",
    treatmentLabel: "Review the proposed Rejuran Healer service",
    treatmentHref: "/treatments/rejuran-h",
  }),
  rejuranDraft({
    slug: "rejuran-eye-area-review",
    title: "Rejuran I and Eye-Area Treatment: A Safety-First Review",
    excerpt:
      "What should be verified before an eye-area polynucleotide treatment is described, offered, or booked in the Philippines.",
    focus: "eye-area treatment",
    treatmentLabel: "Review the proposed Rejuran I / Eye service",
    treatmentHref: "/treatments/rejuran-eye",
  }),
  rejuranDraft({
    slug: "rejuran-s-guide",
    title: "Rejuran S and Scar-Focused Care: What Requires Verification",
    excerpt:
      "A patient-friendly review of scar-focused product identity, evidence limits, doctor assessment, and Philippine authorization checks.",
    focus: "scar-focused care",
    treatmentLabel: "Review the proposed Rejuran S service",
    treatmentHref: "/treatments/rejuran-scar",
  }),
  rejuranDraft({
    slug: "rejuran-product-variants",
    title: "Rejuran Product Variants Are Not Interchangeable",
    excerpt:
      "Why Healer, I, S, HB, and foreign-market topical products should not be treated as one product or one regulatory claim.",
    focus: "product-variant comparison",
  }),
  rejuranDraft({
    slug: "rejuran-philippine-fda-checks",
    title: "How to Check Rejuran Product Status in the Philippines",
    excerpt:
      "A practical checklist for exact product names, local records, suppliers, routes, lots, expiry, and clinic documentation.",
    focus: "Philippine product verification",
  }),
  rejuranDraft({
    slug: "rejuran-consultation-safety",
    title: "Questions to Ask Before a Polynucleotide Treatment",
    excerpt:
      "A consultation checklist covering product identity, doctor qualifications, permitted route, alternatives, risks, aftercare, and realistic expectations.",
    focus: "consultation and informed consent",
  }),
  rejuranDraft({
    slug: "rejuran-results-and-aftercare",
    title: "Rejuran Results and Aftercare: Why Product-Specific Advice Matters",
    excerpt:
      "Why timelines, downtime, adverse effects, and aftercare should not be copied across products or markets before verification.",
    focus: "results, recovery, and aftercare",
  }),
];
