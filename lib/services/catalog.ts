...
export const treatments: ReadonlyArray<Treatment> = [
  ...
  { slug: "hiko-nose-lift", name: "HIKO Nose Lift", category: "Doctor Procedures", summary: "Doctor-performed nose thread procedure planned after an in-person assessment of anatomy, goals and suitability.", priceKind: "assessment", doctorRequired: true, public: true },
  ...
  { slug: "mccm-pdrn", name: "MCCM PDRN Glow & Eye Rejuvenation", category: "Skin Support", summary: "Professional brightening, hydration and eye-contour treatment using MCCM Glutathione Peeling, PDRN and Out Contour Cocktail.", priceKind: "fixed", priceMin: 3800, unit: "session", doctorRequired: false, public: true },
