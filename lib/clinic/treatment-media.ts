...
export const treatmentGalleryCategories: ReadonlyArray<TreatmentGalleryCategory> = [
  ...
  },
  {
    ...
    name: "Skin Support",
    introduction:
      "A review-gated collection of MCCM topical products and proposed doctor-led Rejuran services, organized by product family.",
    treatmentHref: "/treatments/skin-support",
    bookingSlug: "",
    bookingAvailable: false,
    images: [
      {
        src: "/images/optimized/treatments/skin-support/products/mccm-exosome-pdrn-studio.webp",
        alt: "MCCM Exosome PDRN professional-use box and amber vial",
        caption: "MCCM Exosome PDRN product review",
        width: 1440,
        height: 1080,
      },
      {
        src: "/images/optimized/treatments/skin-support/products/rejuran-healer-studio.webp",
        alt: "Rejuran Healer black and silver product box",
        caption: "Rejuran Healer product review",
        width: 1440,
        height: 1080,
      },
      {
        src: "/images/optimized/treatments/skin-support/products/rejuran-eye-studio.webp",
        alt: "Rejuran I silver product box and syringe",
        caption: "Rejuran Eye product review",
        width: 1440,
        height: 1080,
      },
    ],
