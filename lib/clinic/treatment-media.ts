...
export const treatmentGalleryCategories: ReadonlyArray<TreatmentGalleryCategory> = [
  ...
  },
  {
    ...
    name: "Skin Support",
    introduction:
      "Professional MCCM skin-support options organized around hydration, eye-contour, and tone concerns.",
    ...
    images: [
      {
        ...
        caption: "MCCM Exosome PDRN",
        width: 1440,
        height: 1080,
      },
      {
        src: "/images/optimized/treatments/skin-support/products/mccm-eye-contour-studio.webp",
        alt: "MCCM Out Contour professional eye-area product",
        caption: "MCCM Out Contour",
        width: 1440,
        height: 1080,
      },
      {
        src: "/images/optimized/treatments/skin-support/products/mccm-brightening-studio.webp",
        alt: "MCCM professional brightening product",
        caption: "MCCM Brightening System",
        width: 1440,
        height: 1080,
      },
    ],
